...
export declare interface DateTimeFormatOptionsES2020 extends Intl.DateTimeFormatOptions {
...
export declare type FormatDateOptions = Exclude<DateTimeFormatOptionsES2020, 'localeMatcher'> & CustomFormatConfig;
...
export declare const FormattedDateParts: React_2.FC<import("./types").DateTimeFormatOptionsES2020 & CustomFormatConfig & {
    value: string | number | Date | undefined;
...
export declare const FormattedPlural: React_2.ForwardRefExoticComponent<Pick<Props_2, "children" | "other" | "zero" | "one" | "two" | "few" | "many" | "value" | "localeMatcher" | "format" | "type"> & {
...
export declare const FormattedTimeParts: React_2.FC<import("./types").DateTimeFormatOptionsES2020 & CustomFormatConfig & {
    value: string | number | Date | undefined;
    children(val: Intl.DateTimeFormatPart[]): React_2.ReactElement<any, string | ((props: any) => React_2.ReactElement<any, string | any | (new (props: any) => React_2.Component<any, any, any>)> | null) | (new (props: any) => React_2.Component<any, any, any>)> | null;
}>;
...
export declare class IntlProvider extends React_2.PureComponent<OptionalIntlConfig, State> {
    static displayName: string;
    static defaultProps: Pick<IntlConfig, "onError" | "formats" | "messages" | "timeZone" | "textComponent" | "defaultLocale" | "defaultFormats">;
    private cache;
    state: State;
